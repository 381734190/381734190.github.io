...
if(isset($_GET['del_id'])){
	$rec_id = $_GET['del_id'];
	$sql = "DELETE FROM talent_rec WHERE rec_id = '$rec_id'";
	mysql_select_db( 'bdm195587110_db' );
	$retval = mysql_query( $sql, $conn );
	mysql_query($sql);
	if(! $retval )
	{
	  die('删除失败！: ' . mysql_error()).'<a href="talent_rec.php">点击返回</a>';
	}
	header("Location: talent_rec.php");
	exit(0);
}else{
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <li class="menu-list  nav-active"><a href=""><i class="fa fa-institution"></i> <span>招聘管理</span></a>
                    <ul class="sub-menu-list">
						...
						<li class="active"><a href="talent_rec.php"> 人才招聘</a></li>
                            ...
                            <table class="table table-striped table-hover table-bordered" id="editable-sample">
								...
								?>
									<tr class="">
										...
										<td><a href="editor_rec.php?rec_class=talent&edit_id=<?php echo $project[$i]['rec_id']; ?>" >修改</a></td>
										<td><a href="talent_rec.php?del_id=<?php echo $project[$i]['rec_id']; ?>" onclick = "return confirm('确认删除？');">删除</a></td>
									</tr>
								<?php
								}
								?>
