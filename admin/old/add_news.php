...
//    插入语句
    $sql = "INSERT INTO news_tbl " .
        "(news_title,news_description, news_content, news_author, news_img, news_time) " .
        "VALUES " .
        "('$news_title','$news_description','$news_content','$news_author','$picName','$nowDate')";
...
//    传输sql语句
    ...
    if (!$retval) {
		...
		echo "<script>alert('新闻发布成功！');location.href='news_table.php';</script>";   
	}
    ...
    <div class="left-side sticky-left-side">
        ...
        <div class="left-side-inner">
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <li class="active"><a href="add_news.php"><i class="fa fa-tags"></i> <span>新闻发布</span></a></li>
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-sm-7">
                                        ...
                                        <form class="form-horizontal" id="addNews" method="post" enctype="multipart/form-data" action="<?php $_PHP_SELF ?>" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="input-group">
                                                        <input id="docPic" type="text" class="form-control" placeholder="点击浏览选择文件...">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea name="newsDescription" id="newsDescription" class="form-control" cols="30" rows="3"></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        ...
                                        <p><b>注意：</b></p>
										<p>新闻内容中的文章副标题使用“段落格式” > “标题3”。</p>
										<p>正文内容直接输入即可，前端网页已设置自动缩进。</p>
										<p>文章尾部落款部分使用“段落格式” > “标题5”。</p>
										<p>缩略图仅支持JPG、JPEG、GIF、PNG、BMP、PJPEG、X-PNG格式的图片。</p>
										<p>新闻缩略图文件不能大于2MB！</p>
